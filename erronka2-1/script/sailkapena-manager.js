/**
 * Sailkapena Manager - Sailkapenen Kudeaketa Sistema
 * 
 * Sistema osoa sailkapenen kudeaketa egiteko.
 * Funtzionalitate nagusiak:
 * - Denboraldien kudeaketa (sortu, ikusi, ezabatu)
 * - Sailkapen automatikoki kalkulatzea
 * - Taula dinamikoa bistaratzea
 * - Datuen localStorage gordetzea
 * - Admin-ekin editatzeko aukera
 * 
 * Eragiketa logika:
 * 1. Gurutzatzeen datuak irakurtzen ditu
 * 2. Taldeen arteko emaitzen arabera sailkapena kalkulatzen du
 * 3. Puntuazio sistema: Irabaziak (2 puntu), Berdinketak (1 puntu)
 * 4. Taula ordenatzen du puntuazioaren arabera
 * 5. Denboraldien historikoa gordetzen du
 * 
 * @author EEF
