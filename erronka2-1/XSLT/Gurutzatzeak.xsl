...
<!-- 
  Euskal Eskubaloi Federazioa - Gurutzatzeen XSLT Transformazioa
  
  XSLT honek gurutzatzeen XML datuak HTML taula formatura biurtzen ditu.
  Funtzioak:
  - Gurutzatzeen matrizea sortzea (NxN)
  - Emaitzen koloreak ezartzea (victoria/derrota/empate)
  - Taldeen izen laburtuak bistaratzea
  - Data atributuak gehitzea
  - CSS klaseak aplikatzea
  
  Egitura:
  - Errenkadak: Talde lokalak (6 errenkada)
  - Zutabeak: Talde bisitariak (6 zutabe)
  - Diagonala: Talde bera bere aurka (-)
  - Emaitzak: Goleak (gol1-gol2 formatuan)
  
  Koloreak:
  - victoria: Berdea (gol1 > gol2)
  - derrota: Gorria (gol1 < gol2)
  - empate: Horia (gol1 = gol2)
  - pendiente: Grisa (partidarik gabe)
  
  Template nagusiak:
  - match="/": Taula osoa sortzen du
  - name="resultado": Emaitza bakoitza prozesatzen du
  
  Erabilera:
  - Gurutzatzeak orrian erabiltzen da
  - Admin-ek taula editatzeko aukera du
  - JavaScript-ekin interakzioak gaitzeko
  - Estatistikak ikusteko
  
  Output-a: HTML taula (cruces-table)
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  
  <!-- Talde bakunen zerrenda (errepikatuak saihesteko) -->
  <xsl:variable name="uniqueTeams" select="//enfrentamiento/equipo1[not(. = preceding::*/equipo1)]"/>
  
  <!-- Template nagusia: taula osoa -->
  <xsl:template match="/">
